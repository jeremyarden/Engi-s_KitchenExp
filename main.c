...
int main()
{
    ...
    while(cmd != 'x'){
        //tempat sebelum player pindah jadi x lagi
        Elmt(rcopy, sergio.py, sergio.px) = '#';        
        //gerakin player, control:w,a,s,d
        moveplayer(&sergio, room, cmd);
        //tempat player sekarang jadi P
        Elmt(rcopy, sergio.py, sergio.px) = 'P';
        //memastikan apakah ada customer terdekat yang bisa diambil ordernya
